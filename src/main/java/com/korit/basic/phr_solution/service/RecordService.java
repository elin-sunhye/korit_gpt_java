...
import com.korit.basic.phr_solution.repository.RecordRepository;
    ...
    public List<RecordResponseDto> filterRecordsByDiagnosis(String diagnosis) {
        ...
        try {
            ...
            responseDtos = records.stream()
                    ...
                    .map(filterRecord -> new RecordResponseDto(
                            filterRecord.getId(),
                            filterRecord.getPatientId(),
                            filterRecord.getDateOfVisit(),
                            filterRecord.getDiagnosis(),
                            filterRecord.getTreatment(),
                            new Date()
                    ))
                    .collect(Collectors.toList());
