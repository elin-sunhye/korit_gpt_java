...
import com.korit.basic.chapter15.boardApp.repository.BoardRepository;
...
//        해당 데이터 응답 객체로 변환
        BoardResponseDto boardResponseDto = board
                .map(BoardResponseDto::fromEntity)
//                응답 객체로 변환 시 null 값이 존재한다면 예외 발생
...
//        반환
    ...
    public void save(BoardRequestDto boardRequestDto) {
        Board board = boardRequestDto.toEntity(); // ID를 제외한 필드에 사용자의 요청값 할당
