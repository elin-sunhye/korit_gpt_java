...
// === Controller : Model과 View룰 연결하는 역할 ===
class LunchController {
    private LunchMenu model;
    private LunchView view;

    public LunchController(LunchMenu mode, LunchView view) {
        this.model = mode;
        this.view = view;
    }
...
/*
    View (뷰) - 화면 담당
    : 학생들에게 급식표를 보여줌
    >> 급식을 쉽게 볼 수 있도록 보기 좋게 정리
*/
/*
    Controller (컨트롤러) - 연결 담당
    : 모델과 뷰 사이의 통역사
    >> 선생님이 학생의 요청을 급식표에 반영하고 다시 칠판에 업데이트
 */
...
//    모델과 뷰를 줁비
        ...
        controller.setLunchMenu("김밥, 떡볶, 콜라");
